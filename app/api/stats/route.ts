...
export async function GET() {
  ...
  // Compute total cost + token breakdown in one pass
  let totalCost = 0, totalCacheSavings = 0
  let totalInputTokens = 0, totalOutputTokens = 0, totalCacheReadTokens = 0, totalCacheWriteTokens = 0
